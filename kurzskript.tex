...
$[\text{if}_\text{par}]$&\infer{\{P\}\, \text{if $b$ then $S_1$ else $S_2$ end} \,\{Q\}}{\{P \land \mathbb{B}\llbracket b \rrbracket\}\,S_1\,\{Q\} & \{P \land \lnot\mathbb{B}\llbracket b \rrbracket\}\,S_1\,\{Q\}}\\
