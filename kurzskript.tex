...
$[\text{if}^1_\text{NatS}]$&\infer{\langle \text{if $b$ then $C_1$ else $C_2$ end},s\rangle\rightarrow s^\prime}{\langle C_1,s\rangle\rightarrow s^\prime & \mathbb{B}\llbracket b \rrbracket (s) = T}\\
$[\text{if}^2_\text{NatS}]$&\infer{\langle \text{if $b$ then $C_1$ else $C_2$ end},s\rangle\rightarrow s^\prime}{\langle C_2,s\rangle\rightarrow s^\prime & \mathbb{B}\llbracket b \rrbracket (s) = F}\\
$[\text{while}^1_\text{NatS}]$&\infer{\langle \text{while $b$ do $C$ end},s\rangle\rightarrow s^{\prime\prime}}{\langle C,s\rangle\rightarrow s^\prime & \langle \text{while $b$ do $C$ end},s^\prime\rangle\rightarrow s^{\prime\prime} &\mathbb{B}\llbracket b \rrbracket (s) = T}\\
$[\text{while}^2_\text{NatS}]$&\infer{\langle \text{while $b$ do $C$ end},s\rangle\rightarrow s}{\mathbb{B}\llbracket b \rrbracket (s) = F}\\
\end{tabularx}
\begin{equation*}
...
$[\text{if}_\text{par}]$&\infer{\{P\}\, \text{if $b$ then $S_1$ else $S_2$ end} \,\{Q\}}{\{P \land \mathbb{B}\llbracket b \rrbracket\}\,S_1\,\{Q\} & \{P \land \lnot\mathbb{B}\llbracket b \rrbracket\}\,S_2\,\{Q\}}\\
$[\text{while}_\text{par}]$&\infer{\{I\}\, \text{while $b$ do $S$ end} \,\{ I \land \lnot \mathbb{B}\llbracket b \rrbracket\}}{\{I \land \mathbb{B}\llbracket b \rrbracket\}\,S\,\{I\}}\\
