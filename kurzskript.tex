...
\paragraph{Ist ein Problem algorithmisch lösbar?}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Komplexität}
\paragraph{Wie schwierig ist ein lösbares Problem?}
...
\paragraph{Wie können Sprachen beschrieben werden?}
...
\paragraph{Welche (rechnerische) Bedeutung hat ein Programm?}

%\section{Eine einfache Programmiersprache: $W$}

\section{Operationelle Semantik}
\paragraph{Wie entsteht der Effekt eines Programms?}
Bedeutung eines Programms wird angegeben als Sequenz von Schritten, die Zustandstransformationen eines abstrakten Maschinenmodells beschreiben.
Anwendung: Vergleich von Systemen, Model Checking

\section{Denotationelle Semantik}
\paragraph{Was ist der Effekt eines Programms?}
Bedeutung eines Programms wird angegeben durch mathematische Formalismen wie Funktionen, Relationen und Gleichungen.
Anwendung: Statische Analyse

\section{Axiomatische Semantik}
\paragraph{Was lässt sich über den Effekt eines Programms aussagen?}
Bedeutung eines Programms wird angegeben durch Logische Aussagen und Beweiskalküle.
